...
const toOffboarding = (
  ...
  assessmentScores: r.assessment_scores ?? [],
  ...
  linkedinDeadline: r.linkedin_deadline,
...
const offboardingPayload = (input: OffboardingInput) => ({
  ...
  assessment_scores: input.assessmentScores,
  ...
  linkedin_deadline: input.linkedinDeadline,
